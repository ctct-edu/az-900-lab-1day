...
4. 仮想マシンの作成画面が表示されます。
   　※【注意】一部の環境では、仮想マシン作成画面が新しい Create-VM エクスペリエンス（プレビュー） で表示される場合があります。
   　　該当する場合、画面上部に次のようなメッセージが表示されます。
   　　![AZ900_Lab1_04](./media/AZ900_Lab1_00.png)
   　　プレビュー画面のまま進めると、本ラボ手順書の画面や設定項目と一部異なる場合があります。
   　　そのため、上記の案内が表示された場合は、画面上部の
   　　**「以前のエクスペリエンスにアクセスするには、ここをクリックします。」**を選択し、従来の画面へ切り替えてから演習を進めてください。
